                    ...
                    <div class="row">
                        <div class="col-lg-12 col-custom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8 col-xl-5 position-static d-none d-lg-block col-custom">
                                ...
                                <div class="col-lg-2 col-xl-4 col-sm-6 col-6 col-custom">
                                    <div class="header-right-area main-nav">
                                        <ul class="nav">
                                            @if(auth('cus')->check())
                                            <li class="login-register-wrap d-none d-xl-flex">
                                                <span><a href="{{ route('account.profile') }}">Hi
                                                        {{auth('cus')->user()->name}}</a></span>
                                                <span><a href="{{ route('account.change_password') }}">Change
                                                        Password</a></span>
